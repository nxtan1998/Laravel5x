			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href="{{ route('trangchu') }}">Đại Học Công Nghệ Sài Gòn<i class="fa fa-home"></i> </a></li>
		...
		<div class="header-body">
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						{{-- <div class="cart">
							<div class="beta-select" ><i class="fa fa-shopping-cart"  href="{{ route('giohang') }}"></i> {{-- Giỏ hàng (Trống) --}}{{--  <i class="fa fa-chevron-down"></i> --}}</div>
							<div class="beta-dropdown cart-body">
								
								<div class="cart-item">
									<div class="media">
										<a class="pull-left" href="#"><img src="source/image/product/" alt="" height="50px"></a>
			...
			<div class="container">
				...
				<nav class="main-menu">
					<ul class="l-inline ov">
						...
						<li><a href="{{route('dathang')  }}">Đặt Hàng</a></li>
